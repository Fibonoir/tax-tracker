<template>
  <AppPageShell class="app-page app-page--month">
    ...
    <SurfaceCard v-else-if="!hasMonthlyAccess" variant="gradient" padding="lg">
      <div class="ui-form-stack">
        <div>
          <p class="label-xs">Vista premium</p>
          <h1 class="font-display text-4xl leading-none tracking-[-0.05em] text-[var(--text-primary)] mt-3">
            La lettura mensile completa vive in Core Clarity.
          </h1>
          <p class="app-page-copy mt-4">
            Nel piano free hai il cockpit e una preview. Con Core sblocchi ledger del mese,
            breakdown dell’accantonamento e storico operativo completo.
          </p>
        </div>

        <div class="app-grid-2">
          <SurfaceCard variant="soft" padding="md">
            <p class="label-xs">Sblocca</p>
            <p class="app-page-copy mt-3">Ledger mensile, breakdown completo e lettura del mese senza limiti.</p>
          </SurfaceCard>

          <SurfaceCard variant="soft" padding="md">
            <p class="label-xs">Prezzo</p>
            <p class="app-page-copy mt-3">49€/anno con rimborso entro 30 giorni.</p>
          </SurfaceCard>
        </div>

        <div class="ui-form-grid-2">
          <UButton color="primary" class="ui-action-button" :loading="billingLoading" @click="startCoreCheckout">
            Scegli Core
          </UButton>
          <UButton color="neutral" variant="soft" class="ui-action-button--ghost" to="/pricing">
            Vedi piani
          </UButton>
        </div>
      </div>
